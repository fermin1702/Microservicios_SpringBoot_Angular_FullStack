package com.portfolio.microservicios.app.respuestas.controllers;
...
import com.portfolio.microservicios.app.respuestas.services.RespuestaService;
...
public class RespuestaController {
	...
	public ResponseEntity<?> obtenerRespuestasPorAlumnoPorExamen(@PathVariable Long alumnoId,
		...
		Iterable<Respuesta> respuestas = service.findRespuestaByAlumnoByExame(alumnoId, examenId);
